...
export function UsenetOverview() {
    ...
    return <section className="usenet-overview" aria-label="Usenet overview">
        ...
        <SectionOrder storageKey="dashboard-usenet-sections-v1" labels={{ metrics: "Live statistics", memory: "Article memory", activity: "Usenet activity", providers: "Providers", heatmap: "Activity heatmap", reads: "Right now" }}>

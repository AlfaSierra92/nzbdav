...
public partial class UsenetClient
{
    ...
    private async Task ReadBodyToPipeAsync(PipeWriter writer, ArticleMemory.BufferedUsage buffered, CancellationToken cancellationToken, Action onFinally)
    {
        ...
        {
            // Surface producer errors (including memory-limit failures) to the reader instead of silent EOF.
            try { await writer.CompleteAsync(failure).ConfigureAwait(false); }
